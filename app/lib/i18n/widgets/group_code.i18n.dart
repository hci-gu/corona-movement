...
extension Localization on String {
  static var _t = Translations('en_us') +
      ...
      } +
      {
        ...
        'sv_se':
            'Om du har en gruppkod kan du skriva in den här för att gå med i en grupp. Det låter dig jämföra dig med andra i samma grupp.\n\nOm du är intreserad av att testa den här funktionaliteten med din grupp, bolag eller organisation kan du kontakta oss genom sebastian.andreasson@ait.gu.se',
      } +
      {
